...
namespace Zappar
{
    public class ZapparInstantTrackingTarget_EXT : ZapparTrackingTarget, ICameraListener
    {
        public IntPtr? InstantTracker = null;
        [SerializeField, Tooltip("Offset for anchor in camera view before the placement")]
        public Vector3 m_anchorOffsetFromCamera = new Vector3(0, 0, -3);
        ...
        public float m_minZDistance = 3.0f;
        public float m_maxZDistance = 40.0f;
